...
- ::: {}
  - Esses pontos próximos de (0,0) são vistos como pontos de alavancagem, o ajuste não levará muito em conta a presença deles(já que a maioria tem z próximo de 0). --- Provavelmente essa presença apenas vai mudar os outros coeficientes do hiperplano (investigar se esses pontos são influentes).
  :::
...
- Pela natureza do polinômio, parece haver um trade-off entre tentar diminuir o erro dos dados nas caldas ou dos dados no "sino"...
